...
import { MailIcon, PhoneIcon, LinkedinIcon, CalendarIcon, UserIcon } from "lucide-react"
    ...
    <Card className="overflow-hidden border bg-gradient-to-br from-card to-card/80 backdrop-blur-sm">
      <div className="h-24 bg-gradient-to-r from-primary/20 to-primary/10 relative">
        <div className="absolute -bottom-12 left-1/2 -translate-x-1/2">
          <Avatar className="h-24 w-24 border-4 border-background shadow-xl">
            ...
            <AvatarFallback className="bg-primary/20 text-lg font-semibold">AL</AvatarFallback>
          </Avatar>
        </div>
      </div>
      ...
      <CardContent className="text-center">
        ...
        <p className="text-muted-foreground text-sm max-w-xs mx-auto">
          10+ years of experience leading cross-functional teams and delivering enterprise solutions.
        </p>
