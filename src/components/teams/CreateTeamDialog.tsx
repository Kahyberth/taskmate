  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (axios.isAxiosError(error)) {
        notifications.show({
          title: error.code === "ECONNABORTED" ? "Error de conexión 🌐" : "Error al crear el equipo",
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="team-name" name="team-name" placeholder="Enter team name" onChange={(e) => setTeamName(e.target.value)}/>
                </div>
                <div className="grid gap-2">
                  <label htmlFor="team-description">Description</label>
                  <Input id="team-description" name="team-description" placeholder="Enter team description" onChange={(e) => setDescription(e.target.value)}/>
                </div>
              </div>
              <DialogFooter>
